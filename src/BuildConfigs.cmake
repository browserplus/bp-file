...
SET (CMAKE_CONFIGURATION_TYPES Debug Release
     CACHE STRING "bp-file build configs" FORCE)
...
IF(WIN32)
    ...
    SET(CMAKE_CXX_FLAGS_DEBUG "/MTd /DDEBUG /D_DEBUG /Od /RTC1 /RTCc"
        CACHE STRING "bp-file debug CXX flags" FORCE)
    SET(CMAKE_CXX_FLAGS_RELEASE "/MT /DNDEBUG /O1"
        CACHE STRING "bp-file release CXX flags" FORCE)
    ...
    SET(CMAKE_EXE_LINKER_FLAGS "${linkFlags}"
        CACHE STRING "bp-file linker flags" FORCE)
    SET(CMAKE_EXE_LINKER_FLAGS_DEBUG "${linkFlagsDebug}"
        CACHE STRING "bp-file debug linker flags" FORCE)
    SET(CMAKE_EXE_LINKER_FLAGS_RELEASE "${linkFlagsRelease}"
        CACHE STRING "bp-file release linker flags" FORCE)
    SET(CMAKE_MODULE_LINKER_FLAGS "${linkFlags}"
        CACHE STRING "bp-file module linker flags" FORCE)
    SET(CMAKE_MODULE_LINKER_FLAGS_DEBUG "${linkFlagsDebug}"
        CACHE STRING "bp-file module debug linker flags" FORCE)
    SET(CMAKE_MODULE_LINKER_FLAGS_RELEASE "${linkFlagsRelease}"
        CACHE STRING "bp-file module release linker flags" FORCE)
ELSE ()
    SET(isysrootFlag)
    IF (APPLE)
